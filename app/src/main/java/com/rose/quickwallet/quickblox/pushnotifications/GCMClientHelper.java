...
public class GCMClientHelper {
    ...
    public GCMClientHelper(Activity activity, String projectNumber) {
    ...
    private void subscribeToPushNotifications(String regId) {
        ...
        //DialogUtils.showLong(activity.getApplicationContext(),"subscribing to push notifications");
        String deviceId;
